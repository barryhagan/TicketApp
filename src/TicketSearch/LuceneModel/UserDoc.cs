    ...
    internal static class UserDoc
    {
        ...
        public static Document GetSearchDoc(User user)
        {
            var searchDoc = new Document
            {
                ...
                new StringField(InMemoryLuceneSearch.DOC_TYPE_FIELD, typeof(User).Name, Field.Store.YES),
                ...
                new TextField(nameof(user.external_id), user.external_id?.ToString("N") ?? InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO),
                ...
                new StringField(nameof(user.locale), user.locale ?? InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO),
                new StringField(nameof(user.timezone), user.timezone ?? InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO),
                ...
                new TextField(nameof(user.phone), user.phone ?? InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO),
                ...
                new StringField(nameof(user.role), user.role, Field.Store.NO),
            ...
            {
                searchDoc.Add(new StringField(nameof(user.email), InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO));
            ...
            {
                searchDoc.Add(new StringField(nameof(user.tags), InMemoryLuceneSearch.EMPTY_VALUE, Field.Store.NO));
            }
