...
{
    public class UserGraphType : ModelBaseGraphType<User, int>
    {
        public UserGraphType(IDataLoaderContextAccessor dataLoader, TicketBusinessLogic logic) : base(dataLoader, logic)
        {
            Name = "User";
